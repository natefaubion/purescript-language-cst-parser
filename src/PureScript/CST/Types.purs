...
data Type e
  ...
  | TypeApp (Type e) (Type e)
  | TypeOp (Type e) (QualifiedName Operator) (Type e)
...
data Expr e
  ...
  | ExprInfix (Expr e) (Wrapped (Expr e)) (Expr e)
  | ExprOp (Expr e) (QualifiedName Operator) (Expr e)
...
data Binder e
  ...
  | BinderOp (Binder e) (QualifiedName Operator) (Binder e)
  | BinderError e
