...
parseModule = do
  ...
  Tuple imports decls <- token TokLayoutStart *> (Tuple <$> parseModuleImportDecls <*> parseModuleDecls) <* token TokLayoutEnd
  trailingComments <- eof
  pure $ Module { keyword, name, exports, where: where_, imports, decls, trailingComments }
